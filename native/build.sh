...
nix shell \
  ...
  -c sh -c "x86_64-w64-mingw32-gcc -O2 -municode -mwindows src/chocobar_full.c -o chocobar.exe -Ivendor -L$MCFGTHREAD_LIB -ldwmapi -ld2d1 -ldwrite -lpdh -lcomctl32 -lole32 -luuid -lgdi32 -ld3d11 -ldxgi -ldcomp -lwinhttp -Wl,-Bstatic -lmcfgthread -Wl,-Bdynamic"
